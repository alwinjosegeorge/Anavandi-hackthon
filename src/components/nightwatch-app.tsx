...
export function NightwatchApp() {
  ...
  return (
    <div className={cn("nightwatch-root", dark && "dark")}>
      <div className={cn("app-stage", view !== "contact" ? "device-stage" : "full-stage", view === "contact" && "contact-stage")}>
        <div className={cn("app-viewport", view !== "contact" && "device-frame")}>
          {view !== "contact" && <div className="device-island" />}
